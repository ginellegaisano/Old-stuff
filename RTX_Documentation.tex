...
\usepackage{graphicx}
\usepackage{amssymb,amsmath,parskip,fullpage}
\usepackage{array}
...
\item etc
\end{itemize} & Counts the number of times each procedure has been called. Used by our tests for housekeeping as well as error checking. \\ \hline
...
{\bf System Processes} \\ \newline
\begin{tabular}{|L{2cm}|L{4cm}|L{5cm}|L{4cm}|}\hline
...
\newline
{\bf User Processes:} \\ \newline 
\begin{tabular}{|L{3.5cm}|L{7cm}|L{5cm}|}\hline
...
The data presented shows a linear correlation, however small variances (of about 1 - 2 us) may become apparent if the number of blocks increases or timing interrupts occur. 
